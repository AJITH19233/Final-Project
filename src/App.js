...
import Pdf from './ui-component/Pdf';
...
import Reportsubmission from './ui-component/Reportsubmission';
import Weeksubmission from './ui-component/Weeksubmission';
...
import Scorecard from './ui-component/Scorecard';
import Overview from './ui-component/Overview';
function App() {
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='week' element={<Weeksubmission />} />
        <Route path='mssg' element={<Messages />} />
